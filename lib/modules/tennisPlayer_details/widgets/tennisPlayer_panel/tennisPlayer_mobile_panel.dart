...
import 'package:pokedex/modules/tennisPlayer_details/widgets/tennisPlayer_panel/pages/about/about_page.dart';

//import 'package:pokedex/modules/pokemon_details/widgets/pokemon_panel/pages/base_stats/base_stats_page.dart';
import 'package:pokedex/modules/tennisPlayer_details/widgets/tennisPlayer_panel/pages/base_stats/base_stats_page.dart';
...
class TennisPlayerMobilePanelWidget extends StatefulWidget {
  final Function(double position) listener;
  // 有这Function，是因为之后要用到onPanelSlide，这属性就是得用 Function。

  const TennisPlayerMobilePanelWidget({
    Key? key,
    required this.listener,
  }) : super(key: key);

  @override
  _TennisPlayerMobilePanelWidgetState createState() =>
      _TennisPlayerMobilePanelWidgetState();
}

class _TennisPlayerMobilePanelWidgetState
    extends State<TennisPlayerMobilePanelWidget>
    with
        TickerProviderStateMixin,
        AutomaticKeepAliveClientMixin<TennisPlayerMobilePanelWidget> {
                    ...
                    flexibleSpace: Stack(
                      children: [
                        ...
                        Container(
                          ...
                          child: TabBar(
                            unselectedLabelColor: AppTheme.getColors(context)
                                .tennisPlayerTabTitle,
                            // unselectedLabelColor，改成 Colors.red 无作用。
                            labelColor: AppTheme.getColors(context)
                                .selectTennisPlayerTabTitle,
