...
class TennisPlayerDetailsPage extends StatefulWidget {
  ...
  const TennisPlayerDetailsPage({Key? key, this.isFavoritePokemon = false})
      : super(key: key);
                ...
                Observer(builder: (_) {
                  return AppBar(
                    ...
                    actions: [
                      ...
                      IconButton(
                        // 这边的onPressed，不明白意义为何，他到底open了啥EndDrawer?。
                        onPressed: () {
                          Scaffold.of(context).openEndDrawer();
                          print('这边的onPressed，不明白意义为何，他到底open了啥EndDrawer?');
                        },
