...
class TennisPlayerRightOrLeftItemWidget extends StatelessWidget {
  final String rightOrLeft;
  final Color? color;
  final VoidCallback onClick;

  const TennisPlayerRightOrLeftItemWidget(
      {Key? key,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Image.asset(
                          AppConstants.tennisPlayerRightOrLeftLogo(rightOrLeft,
                              size: 60),
                          width: 60,
                          height: 60,
                        )
