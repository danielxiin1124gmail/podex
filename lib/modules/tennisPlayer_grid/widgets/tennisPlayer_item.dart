...
class TennisPlayerItemWidget extends StatelessWidget {
  final TennisPlayerSummary tennisPlayer;
  final bool isFavorite;

  const TennisPlayerItemWidget(
      {Key? key, required this.tennisPlayer, this.isFavorite = false})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color:
            AppTheme.getColors(context).tennisPlayerItem(tennisPlayer.types[0]),
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Container(
                  child: Hero(
                    tag: isFavorite
                        ? "favorite-tennisPlayer-image-${tennisPlayer.number}"
                        : "tennisPlayer-image-${tennisPlayer.number}",
                    child: ImageUtils.networkImage(
                      url: tennisPlayer.thumbnailUrl,
