...
class AppColorsDark extends AppColors {
  ...
  @override
  Color get tennisPlayerTabTitle => Color(0xFF303943).withOpacity(0.4);

  @override
  Color get selectPokemonTabTitle => Color(0xFF303943);
  @override
  Color get selectTennisPlayerTabTitle => Color(0xFF303943);
  ...
  @override
  Color get tennisPlayerDetailsTitleColor => Color(0xFF121212);
