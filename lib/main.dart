...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // 这里是标准写法，如同 bot_toast | Flutter Package - Pub.dev 的简介所述。
    ...
    return ThemeProvider(
      ...
      child: MaterialApp(
        ...
        builder: (context, child) {
          ...
          // 整个 builder去掉不致于直接 error，只是当新增怪兽时、当应当弹出Toast时，会在底下弹出错误。
          // 这里是标准写法，如同 bot_toast | Flutter Package - Pub.dev 的简介所述。
        },
        theme: lightTheme, // 这不起任何作用。上面的 initTheme 才是决定日夜模式的地方。
        navigatorObservers: [BotToastNavigatorObserver()],
        // navigatorObservers 目的是侦测 navigation events 与显示 toast。
        // 这里是标准写法，如同 bot_toast | Flutter Package - Pub.dev 的简介所述。
